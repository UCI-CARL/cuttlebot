...
class Camera():
    def __init__(self):
        ...
        self.focal_length_mm = 3.15 #???Not sure what it is
        ...
        full_size_sensing_mode = self.picam2.sensor_modes[-1]
        self.width_full = full_size_sensing_mode["size"][0] #2592 for fisheye cam
        self.height_full = full_size_sensing_mode["size"][1] #1944 for fisheye cam
        #specify the sensing mode for the image
        self.sensing_mode = 0 #0, 1, 2, 3 for the fisheye lens camera
