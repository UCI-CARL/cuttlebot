...
class PanTiltUnit():
    ...
    def __init__(self):
        ...
        #self.controller = Proportional_2D(cam_FOV=100, cam_dim=(320,240), target_value_proportion=0.1, hysteresis_rad=0.05)
        self.controller = Direct_2D(cam_FOV=100, cam_dim=(320,240), hysteresis_rad=0.05)
